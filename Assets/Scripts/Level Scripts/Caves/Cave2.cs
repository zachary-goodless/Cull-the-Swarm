...
public class Cave2 : MonoBehaviour {
	...
	IEnumerator LevelLayout(){
		...
		waves.StartSpawnLinear(snail,4,.5f,250,0,-1,100,500,waves.upScreen,Quaternion.identity,-250,0,"d5");
		yield return new WaitForSeconds (3f);
		...
		waves.StartSpawnSin (drone, 4, 1.5f, 10, 2, 250, 1, 0, 400, waves.leftScreen, -200, Quaternion.identity, 0, 0, "d5");
		yield return new WaitForSeconds (8f);
		...
		waves.StartSpawnLinear (turret, 1, 0, 150, 0, -1, 180, -400, waves.upScreen, Quaternion.identity, 0, 0, "t1");
		yield return new WaitForSeconds (3f);
		...
		waves.StartSpawnLinear (turret, 1, 0, 150, 0, -1, 180, 0, waves.upScreen, Quaternion.identity, 0, 0, "t1");
		yield return new WaitForSeconds (3f);
		...
		waves.StartSpawnWorms(1,6,0,.5f,30,250,1,200,waves.rightScreen,300,Quaternion.Euler(0,0,-90),0,0,"d1");
		yield return new WaitForSeconds (2f);

		//Wave Sixteen ( 2 sec after) - 1 worm moves across the top of the area of the screen from left to right.
		waves.StartSpawnWorms(1,6,0,.5f,30,250,1,200,waves.leftScreen,150,Quaternion.Euler(0,0,90),0,0,"d1");
		yield return new WaitForSeconds (8f);

		//Wave Seventeen (8 sec after)- column of 2 drones wide, 4 drones tall from the center of the screen.
		waves.StartSpawnFollow(snail,4,.8f,.02f,0,250,1,100,100,waves.upScreen,Quaternion.identity,0,0,"d5");
		waves.StartSpawnFollow(snail,4,.8f,-.02f,0,250,1,100,-100,waves.upScreen,Quaternion.identity,0,0,"d5");
		yield return new WaitForSeconds (4f);
		...
		waves.StartSpawnTopToSide(snail, 5, 1, 5,180,1,-1,120,-600,waves.upScreen,Quaternion.identity,0,0,"d1");
		yield return new WaitForSeconds (3f);
		...
		waves.StartSpawnTopToSide(snail, 5, 1, 4,180,-1,-1,120,600,waves.upScreen,Quaternion.identity,0,0,"d1");
		yield return new WaitForSeconds (8f);

		//Wave Twenty-One (8 sec after)- 4 drones form background to the center top area. Move linearly to the bottom of the screen.
		waves.StartSpawnFromBackground(drone, 4, 1, 2f, new Vector3(0,350,50), 250, 0, -1, 100, 0,-400,Quaternion.identity,0,0,"d5");
		yield return new WaitForSeconds (4f);
		
		//Wave Twenty-Two (4 sec after)- 4 snails from left top area of the screen, move linearly towards bottom of the screen.
		waves.StartSpawnLinear(snail,4,1.5f,150,0,-1,120,-500,waves.upScreen,Quaternion.identity,0,0,"d5");
		waves.StartSpawnLinear(snail,4,1.5f,150,0,-1,120,500,waves.upScreen,Quaternion.identity,0,0,"d1");
		yield return new WaitForSeconds (4f);
