...
public class Cave2 : MonoBehaviour {
	...
	IEnumerator LevelLayout(){
		...
		waves.StartSpawnSin (drone, 5, 1.5f, 10, 2, 250, -1, 0, 100, waves.rightScreen, 200, Quaternion.identity, 0, 0, "");
		...
		waves.StartSpawnLinear(drone,4,.5f,250,0,-1,100,500,waves.upScreen,Quaternion.identity,-250,0,"");
		yield return new WaitForSeconds (3f);
		...
		waves.StartSpawnWorms (1, 6, 0, .5f, 20, 250, 1, 200, waves.leftScreen, -400, Quaternion.Euler(0,0,90), 0, 0, "");
		yield return new WaitForSeconds (3f);

		//Wave Five ( 1 sec after)- 1 worm, moves along the bottom above the original worm, from right to left.
		waves.StartSpawnWorms (1, 6, 0, .5f, 20, 250, 1, 200, waves.rightScreen, -250, Quaternion.Euler(0,0,-90), 0, 0, "");
		yield return new WaitForSeconds (1f);

		//Wave Six (1 sec after)- 1 worm, moves along the bottom above Wave Four, from left to right.
		waves.StartSpawnWorms (1, 6, 0, .5f, 20, 250, 1, 200, waves.leftScreen, -100, Quaternion.Euler(0,0,90), 0, 0, "");
		yield return new WaitForSeconds (2f);

		//Wave Seven (2 sec after)- 4 drones moving in a sine wave across the left to right at the top of the screen.
		waves.StartSpawnSin (drone, 4, 1.5f, 10, 2, 250, 1, 0, 400, waves.leftScreen, -200, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (8f);

		//Wave Eight (8 sec after)- 2 drones on the left side of the screen. Move linearly to the bottom of the screen.
		waves.StartSpawnLinear (snail, 2, 0, 200, 0, -1, 100, -500, waves.upScreen, Quaternion.identity, 300, 0, "");
		yield return new WaitForSeconds (1f);

		//Wave Nine ( .5-1 sec after)- 1 turret on the left side of the screen. Move linearly to the bottom of the screen
		waves.StartSpawnLinear (turret, 1, 0, 150, 0, -1, 180, -400, waves.upScreen, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (3f);

		//Wave Ten (2 sec after)- 2 drones on the middle of the screen. Moves linearly to the bottom of the screen.
		waves.StartSpawnLinear (snail, 2, 0, 200, 0, -1, 100, -150, waves.upScreen, Quaternion.identity, 300, 0, "");
		yield return new WaitForSeconds (1f);
		...
		waves.StartSpawnLinear (turret, 1, 0, 150, 0, -1, 180, 0, waves.upScreen, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (3f);
		...
		waves.StartSpawnFromBackground (drone, 3, 1, 2.5f, new Vector3 (-600, -400, 50), 250, 1, 1, 100, -650, 400, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (4f);
		...
		waves.StartSpawnWorms(1,6,0,.5f,30,250,1,200,waves.rightScreen,300,Quaternion.Euler(0,0,-90),0,0,"");
		yield return new WaitForSeconds (2f);

		//Wave Sixteen ( 2 sec after) - 1 worm moves across the top of the area of the screen from left to right.
		waves.StartSpawnWorms(1,6,0,.5f,30,250,1,200,waves.leftScreen,150,Quaternion.Euler(0,0,90),0,0,"");
		yield return new WaitForSeconds (8f);

		//Wave Seventeen (8 sec after)- column of 2 drones wide, 4 drones tall from the center of the screen.
		waves.StartSpawnFollow(drone,4,.8f,.02f,0,250,1,100,100,waves.upScreen,Quaternion.identity,0,0,"");
		waves.StartSpawnFollow(drone,4,.8f,-.02f,0,250,1,100,-100,waves.upScreen,Quaternion.identity,0,0,"");
		yield return new WaitForSeconds (4f);
		...
		waves.StartSpawnFromBackground(drone, 4, 1, 2f, new Vector3(0,350,50), 250, 0, -1, 100, 0,-400,Quaternion.identity,0,0,"");
		yield return new WaitForSeconds (4f);
