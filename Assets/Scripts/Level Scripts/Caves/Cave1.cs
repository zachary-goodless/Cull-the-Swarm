...
public class Cave1 : MonoBehaviour {
	...
	IEnumerator LevelLayout(){
		...
		waves.StartSpawnLinear (snail, 3, 0, 200, 0, -1, 120, -700, waves.upScreen, Quaternion.identity, 200, 0, "");
		yield return new WaitForSeconds (1f);

		//Wave Three (1 sec after)- one turret, lined behind the three drone wave.
		waves.StartSpawnLinear (turret, 1, 0, 200, 0, -1, 150, -500, waves.upScreen, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (3f);
		...
		waves.StartSpawnLinear (snail, 3, 0, 200, 0, -1, 120, -200, waves.upScreen, Quaternion.identity, 200, 0, "");
		yield return new WaitForSeconds (1f);


		waves.StartSpawnLinear (turret, 1, 0, 200, 0, -1, 150, 0, waves.upScreen, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (6f);

		//Wave Seven (6 sec after)-  2 turrets, evenly spaced around the middle of the screen
		waves.StartSpawnLinear (turret, 2, 0, 200, 0, -1, 150, -400, waves.upScreen, Quaternion.identity, 800, 0, "");
		yield return new WaitForSeconds (3f);

		//Wave Eight (3 sec after)-  5 drones curve from the outside left of the screen towards the center and exit on the right
		waves.StartSpawnSideToBottom (drone, 5, 1.5f, 7, 250, 1, -1, 100, waves.leftScreen, 200, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (3f);

		//Wave Eight (3 sec after)- 5 drones curve from the outside right of the screen towards the center and exit on the left
		waves.StartSpawnSideToBottom (drone, 5, 1.5f, 7, 250, -1, 1, 100, waves.rightScreen, -200, Quaternion.identity, 0, 0, "");
		...
		waves.StartSpawnFromBackground (drone, 4, 1, 2, new Vector3 (0, waves.upScreen - 200, 50), 200, .5f, -1, 100, -600, -400, Quaternion.identity, 0, 200, "");
		yield return new WaitForSeconds (8f);
		...
		waves.StartSpawnWorms (1, 6, 0, .5f, 30, 200, 1, 200, waves.leftScreen, 200, Quaternion.Euler (0, 0, 90), 0, 0, "");
		yield return new WaitForSeconds (4f);

		//Wave Eleven (4 sec after)- 1 worm from right side of the screen slinks linearly across to the left.
		waves.StartSpawnWorms (1, 6, 0, .5f, 30, 200, 1, 200, waves.rightScreen, -200, Quaternion.Euler (0, 0, -90), 0, 0, "");
		yield return new WaitForSeconds (8f);

		//Wave Twelve (8 sec after)-  2 worm from top left side of the screen move linearly towards bottom of the screen.
		waves.StartSpawnWorms (2, 6, 0, .5f, 40, 250, 1, 200, -600, waves.upScreen, Quaternion.Euler (0, 0, 0), 300, 0, "");
		yield return new WaitForSeconds (4f);
		...
		waves.StartSpawnWorms (1, 6, 0, .5f, 40, 250, 1, 200, -150, waves.upScreen, Quaternion.Euler (0, 0, 0), 300, 0, "");
		waves.StartSpawnWorms (1, 6, 0, -.5f, 40, 250, 1, 200, 150, waves.upScreen, Quaternion.Euler (0, 0, 0), 300, 0, "");
		...
		*/
		...
		waves.StartSpawnLinear (drone, 3, 0, 250, .7f, .5f, 100, waves.leftScreen-400, waves.downScreen - 200, Quaternion.identity, 200, -200, "");
		yield return new WaitForSeconds (5f);

		//Wave Sixteen (5 sec after)- 3 drones from right bottom of the screen move linearly towards the top left side of the screen.
		waves.StartSpawnLinear (drone, 3, 0, 250, -.7f, .5f, 100, waves.rightScreen+400, waves.downScreen - 200, Quaternion.identity, -200, -200, "");
		yield return new WaitForSeconds (4f);
		...
		waves.StartSpawnLinear (turret, 3, 1.5f, 200, 0, -1, 150, 0, waves.upScreen, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (3f);
		...
		waves.StartSpawnFromBackground (drone, 4, 1, 2.5f, new Vector3 (-600, 400, 50), 250, 1, -1, 100, -650, -300, Quaternion.identity, 0, 0, "");
		yield return new WaitForSeconds (3f);
